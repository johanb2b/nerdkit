...
start_term_session() {
    ...
    echo -e "\n  ${G_ACCENT}${BOLD}ANSLUTER TILL $host...${RESET}"
    echo -e "  ${G_GREY}------------------------------------------------------------${RESET}"
    echo -e "  ${BOLD}Hjälp för att avsluta:${RESET}"
    echo -e "  - Skriv ${G_CYAN}'exit'${RESET} för att stänga sessionen helt."
    echo -e "  - Tryck ${G_CYAN}Ctrl+b${RESET} sedan ${G_CYAN}d${RESET} för att lämna sessionen körande i bakgrunden."
    echo -e "  - Om anslutningen låst sig: Tryck ${G_CYAN}Enter${RESET} sedan ${G_CYAN}~.${RESET} (tilde punkt)."
    echo -e "  ${G_GREY}------------------------------------------------------------${RESET}"
    echo -e "  Ansluter om 4 sekunder..."
    sleep 4
